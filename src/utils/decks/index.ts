...
import standardJokers, {CARDS as STANDARD_JOKERS_CARDS} from "./standardJokers";
...
import standard32Jokers, {CARDS as STANDARD32_JOKERS_CARDS} from "./standard32Jokers";
import empty, {CARDS as EMPTY_CARDS} from "./empty";
import custom from "./custom";
import { DeckQuery } from './deckQuery';
import { DeckParams } from './deckParams';

export const generators: { [key: string]: (params: DeckQuery) => DeckParams} = {
	standard: standard,
